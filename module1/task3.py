...
ax[0].set_ylabel(r"Difference between  $\Delta$t and $\Delta$t/2")
ax[1].plot(np.arange(0,200), timestep1[2], label = "I")
ax[1].set_xlabel("Time")
ax[1].set_ylabel(r"Difference between  $\Delta$t and $\Delta$t/2")
ax[2].plot(np.arange(0,200), timestep1[3], label = "R")
ax[2].set_xlabel("Time")
ax[2].set_ylabel(r"Difference between  $\Delta$t and $\Delta$t/2")
ax[3].plot(np.arange(0,200), np.max(timestep1[1:], axis=0))
ax[3].set_xlabel("Time")
ax[3].set_ylabel(r"Difference between  $\Delta$t and $\Delta$t/2")
ax[0].set_title("S")
ax[1].set_title("I")
ax[2].set_title("R")
ax[3].set_title("All")
fig.suptitle(r"Difference as a function of time with stepsize $\Delta$ t = 1")
plt.savefig("images/difference_plot1")
...
ax[2].set_xlabel("Time")
ax[2].set_ylabel(r"Difference between  $\Delta$t and $\Delta$t/2")
ax[3].plot(np.arange(0,200), np.max(timestep2[1:],axis=0))
ax[3].set_xlabel("Time")
ax[3].set_ylabel(r"Maximal difference between  $\Delta$t and $\Delta$t/2")
ax[0].set_title("S")
ax[1].set_title("I")
ax[2].set_title("R")
ax[3].set_title("All")
fig.suptitle(r"Difference as a function of time with stepsize $\Delta$ t = 1/1000")
plt.savefig("images/difference_plot2")